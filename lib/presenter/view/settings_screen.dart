  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _RangeRow(
          label: 'Translation',
          value: state.translationScale,
          min: 0.7,
          max: 1.5,
          onChanged: cubit.setTranslationScale,
        ),
        _RangeRow(
          label: 'Teeka',
          value: state.teekaScale,
          min: 0.7,
          max: 1.5,
          onChanged: cubit.setTeekaScale,
        ),
        _RangeRow(
          label: 'Transliteration',
          value: state.translitScale,
          min: 0.7,
          max: 1.5,
          onChanged: cubit.setTranslitScale,
        ),
        _RangeRow(
          label: 'Announcements',
          value: state.announcementScale,
          min: 0.7,
          max: 1.5,
          onChanged: cubit.setAnnouncementScale,
        ),
        _ButtonRow(
